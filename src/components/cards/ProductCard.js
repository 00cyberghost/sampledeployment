        ...
        >
          ...
          >
            ...
            >
              ...
              <CustomOverLay hover={state.isTransformed} border_radius="10px" sx={{background:"transparent"}}>
                <QuickView
                  quickViewHandleClick={quickViewHandleClick}
                  addToWishlistHandler={addToWishlistHandler}
                  removeFromWishlistHandler={removeFromWishlistHandler}
              ...
              {!isProductExist && cardFor !== "list-view" && (
                <Box
                sx={{
                  position: "absolute",
                  right: 10,
              ...
              >
                  ...
                  <IconButton size="small" variant="contained" color="primary" sx={{background:"white",borderRadius:"50%",border:"0.1px green solid"}} onClick={(e) => cartAddToCartClick?.(e)}>
                      <AddIcon />
                  </IconButton>
                  </PrimaryToolTip>
                </Box>
