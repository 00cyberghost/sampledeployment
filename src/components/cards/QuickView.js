		...
		<>
			...
			>
				{!noQuickview && (
					...
					// 	</IconButtonStyled>
					// </PrimaryToolTip>
				   <Button size="small" sx={{background:"white", color:"#039D55", borderRadius:"20px", marginRight:"10px",marginTop:"10px"}} onClick={(e) => quickViewHandleClick(e)}>
					QuickView
				   </Button>
				)}
				{/* {!noWishlist && (
					...
					<>
						{isLoading ? (
							...
							<PrimaryToolTip text="Add to cart">
								<IconButtonStyled
									onClick={(e) => cartAddToCartClick?.(e)}
								>
									<ShoppingBagIcon />
								</IconButtonStyled>
							</PrimaryToolTip>
