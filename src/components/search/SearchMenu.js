            ...
            {showView ? (
              ...
              >
                ...
                {isSmallSize ? null : <Body2 text="Grid view" />} */}
                 {isSmallSize ? null : <WindowIcon />}
                 <Body2  color={isSmallSize?theme.palette.primary:""} text="Grid view" />
              </ViewWrapper>
            ) : null}
          </Grid>
          {/* <Grid item xs={4} md={2}> */}
          <Grid item xs={4.5} md={2}>
            {showView ? (
              ...
              >
                ...
                {isSmallSize ? null : <ViewListIcon sx={{ fontSize: "30px" }} />}
                <Body2 color={isSmallSize?theme.palette.primary:""}  text="List view" />
              </ViewWrapper>
            ) : null}
          </Grid>
          {isSmallSize ? null : (
